...
class TypewiseTest(unittest.TestCase):
    ...
    def test_PrintMovingAveragesintoConsole(self):
        self.assertTrue(StreamLine_receiver.PrintMovingAveragesintoConsole(sample_Value_from_sender)==(29.2, 29.6, 0.276))

    def test_PrintRangesOfParamsIntoConsole(self):
        self.assertTrue(StreamLine_receiver.PrintRangesOfParamsIntoConsole(sample_Value_from_sender)==(15,45,10,67,0.05,0.7))
    ...
    def test_CalculateMovingAverages(self):
        self.assertTrue(StreamLine_receiver.CalculateMovingAverages(sample_Value_from_sender)==(29.2, 29.6, 0.276))
    
    def test_FindRangeValues(self):
        self.assertTrue(StreamLine_receiver.FindRangeValues([one_reading['temp'] for one_reading in sample_Value_from_sender], [one_reading['SoC'] for one_reading in sample_Value_from_sender], [one_reading['ChargeRate'] for one_reading in sample_Value_from_sender])==(15,45,10,67,0.05,0.7))
